...
public class JavaResourceController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<FileResource> filelist=fileservice.getFileResourcebyCategory(resourcename);
		PptResourceInterfaceService pptservice=new PptResourceInterfaceService();
		ArrayList<PptResource> pptlist=pptservice.getPptResourcebyCategory(resourcename);
